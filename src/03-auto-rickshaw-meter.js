...
export function calculateAutoFare(distance, waitingMinutes = 0) {
  // Your code here
  if (typeof distance !== 'number' || distance <= 0 || isNaN(distance)) return -1;
  if (typeof waitingMinutes !== 'number' || waitingMinutes < 0 || isNaN(waitingMinutes)) return -1;
